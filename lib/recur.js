...
(function () {
   	...
   	* are chainable to simplify the process.
    * 
    * Example:
    *
    ...
    *        .except().on(0, 1).month();
	...
	var Recur = function () {
		...
		var schedules = [{}]
		  ...
		  , curArr = schedules
		  , curName
		  , values, every, applyMin, applyMax, i
		  , last
		...
		return {
			...
			dayOfMonth: function () {
		   	...
		   	* Minimum value is 0, maximum value is 6.  Specify 6 for last.
		   	* 0 - Sunday
		   	* 1 - Monday
		   	* 2 - Tuesday
		   	* 3 - Wednesday
			...
			dayOfWeek: function () {
		   	...
		   	* Minimum value is 0, maximum value is 4.  Specify -1 for last.
		   	* 0 - First occurrence
		   	* 1 - Second occurrence
		   	* 2 - Third occurrence
		   	* 3 - Fourth occurrence
			...
			weekOfYear: function () {
		   	...
		   	* Minimum value is 0, maximum value is 11.  Specify 11 for last.
		   	* 0 - January
		   	* 1 - February
		   	* 2 - March
		   	* 3 - April
