...
if (! _$jscoverage['parse/cron.js']) {
  ...
  _$jscoverage['parse/cron.js'][22] = 0;
  _$jscoverage['parse/cron.js'][25] = 0;
  _$jscoverage['parse/cron.js'][32] = 0;
  _$jscoverage['parse/cron.js'][50] = 0;
  _$jscoverage['parse/cron.js'][51] = 0;
  _$jscoverage['parse/cron.js'][60] = 0;
  _$jscoverage['parse/cron.js'][61] = 0;
  _$jscoverage['parse/cron.js'][63] = 0;
  _$jscoverage['parse/cron.js'][64] = 0;
  _$jscoverage['parse/cron.js'][65] = 0;
  _$jscoverage['parse/cron.js'][69] = 0;
  _$jscoverage['parse/cron.js'][81] = 0;
  _$jscoverage['parse/cron.js'][82] = 0;
  _$jscoverage['parse/cron.js'][84] = 0;
  _$jscoverage['parse/cron.js'][85] = 0;
  _$jscoverage['parse/cron.js'][88] = 0;
  _$jscoverage['parse/cron.js'][89] = 0;
  _$jscoverage['parse/cron.js'][90] = 0;
...
later.parse.cron = (function (expr, hasSeconds) {
  ...
  _$jscoverage['parse/cron.js'][32]++;
  var FIELDS = {s: [0, 0, 59], m: [1, 0, 59], h: [2, 0, 23], D: [3, 1, 31], M: [4, 1, 12], Y: [6, 1970, 2099], d: [5, 1, 7, 1]};
  _$jscoverage['parse/cron.js'][50]++;
  function getValue(value, offset) {
    _$jscoverage['parse/cron.js'][51]++;
    return (isNaN(value)? (NAMES[value] || null): ((+ value) + (offset || 0)));
}
  _$jscoverage['parse/cron.js'][60]++;
  function cloneSchedule(sched) {
    _$jscoverage['parse/cron.js'][61]++;
    var clone = {}, field;
    _$jscoverage['parse/cron.js'][63]++;
    for (field in sched) {
      _$jscoverage['parse/cron.js'][64]++;
      if (((field !== "dc") && (field !== "d"))) {
  ...
  _$jscoverage['parse/cron.js'][81]++;
  function add(sched, name, min, max, inc) {
    _$jscoverage['parse/cron.js'][82]++;
    var i = min;
    _$jscoverage['parse/cron.js'][84]++;
    if ((! sched[name])) {
      _$jscoverage['parse/cron.js'][85]++;
      sched[name] = [];
    }
    _$jscoverage['parse/cron.js'][88]++;
    while ((i <= max)) {
      _$jscoverage['parse/cron.js'][89]++;
      if ((sched[name].indexOf(i) < 0)) {
        _$jscoverage['parse/cron.js'][90]++;
        sched[name].push(i);
      }
  ...
  function addHash(schedules, curSched, value, hash) {
    ...
    _$jscoverage['parse/cron.js'][114]++;
    add(curSched, "d", value, value);
    _$jscoverage['parse/cron.js'][115]++;
  ...
  function addWeekday(s, curSched, value) {
    ...
    if ((value === 1)) {
      _$jscoverage['parse/cron.js'][123]++;
      add(curSched, "D", 1, 3);
      _$jscoverage['parse/cron.js'][124]++;
      add(curSched, "d", NAMES.MON, NAMES.FRI);
      _$jscoverage['parse/cron.js'][125]++;
      add(except1, "D", 2, 2);
      _$jscoverage['parse/cron.js'][126]++;
      add(except1, "d", NAMES.TUE, NAMES.FRI);
      _$jscoverage['parse/cron.js'][127]++;
      add(except2, "D", 3, 3);
      _$jscoverage['parse/cron.js'][128]++;
      add(except2, "d", NAMES.TUE, NAMES.FRI);
    }
    else {
      _$jscoverage['parse/cron.js'][133]++;
      add(curSched, "D", (value - 1), (value + 1));
      _$jscoverage['parse/cron.js'][134]++;
      add(curSched, "d", NAMES.MON, NAMES.FRI);
      _$jscoverage['parse/cron.js'][135]++;
      add(except1, "D", (value - 1), (value - 1));
      _$jscoverage['parse/cron.js'][136]++;
      add(except1, "d", NAMES.MON, NAMES.THU);
      _$jscoverage['parse/cron.js'][137]++;
    ...
    _$jscoverage['parse/cron.js'][141]++;
    s.exceptions.push(except2);
}
  _$jscoverage['parse/cron.js'][154]++;
  function addRange(item, curSched, name, min, max, offset) {
    _$jscoverage['parse/cron.js'][156]++;
    var incSplit = item.split("/"), inc = (+ incSplit[1]), range = incSplit[0];
    _$jscoverage['parse/cron.js'][161]++;
    if (((range !== "*") && (range !== "0"))) {
      _$jscoverage['parse/cron.js'][162]++;
      var rangeSplit = range.split("-");
      _$jscoverage['parse/cron.js'][163]++;
      min = getValue(rangeSplit[0], offset);
      _$jscoverage['parse/cron.js'][166]++;
      max = (getValue(rangeSplit[1], offset) || max);
    }
    _$jscoverage['parse/cron.js'][168]++;
    add(curSched, name, min, max, inc);
}
  _$jscoverage['parse/cron.js'][181]++;
  function parse(item, s, name, min, max, offset) {
    _$jscoverage['parse/cron.js'][182]++;
  ...
  _$jscoverage['parse/cron.js'][220]++;
  function isHash(item) {
    _$jscoverage['parse/cron.js'][221]++;
    return ((item.indexOf("#") > -1) || (item.indexOf("L") > 0));
}
  _$jscoverage['parse/cron.js'][225]++;
  function itemSorter(a, b) {
    _$jscoverage['parse/cron.js'][226]++;
    return ((isHash(a) && (! isHash(b)))? 1: 0);
}
  _$jscoverage['parse/cron.js'][235]++;
  function parseExpr(expr) {
    _$jscoverage['parse/cron.js'][236]++;
    var schedule = {schedules: [{}], exceptions: []}, components = expr.split(" "), field, f, component, items;
    _$jscoverage['parse/cron.js'][240]++;
    for (field in FIELDS) {
      _$jscoverage['parse/cron.js'][241]++;
      f = FIELDS[field];
      _$jscoverage['parse/cron.js'][242]++;
      component = components[f[0]];
      _$jscoverage['parse/cron.js'][243]++;
      if ((component && (component !== "*") && (component !== "?"))) {
        _$jscoverage['parse/cron.js'][247]++;
        items = component.split(",").sort(itemSorter);
        _$jscoverage['parse/cron.js'][248]++;
        var i, length = items.length;
        _$jscoverage['parse/cron.js'][249]++;
        for (i = 0; (i < length); (i++)) {
          _$jscoverage['parse/cron.js'][250]++;
          parse(items[i], schedule, field, f[1], f[2], f[3]);
}
      }
}
    _$jscoverage['parse/cron.js'][255]++;
    return schedule;
}
  _$jscoverage['parse/cron.js'][258]++;
  var e = expr.toUpperCase();
  _$jscoverage['parse/cron.js'][259]++;
